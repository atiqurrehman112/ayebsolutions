...
- `src/features/home`: homepage sections and presentation. Sprint 4A provides the hero, Sprint 4B provides trust and social proof, Sprint 4C provides the services overview, Sprint 4D provides the portfolio and case-study preview, Sprint 4E provides the interactive AI automation showcase, Sprint 4F provides the development process, engineering approach, and quality-practices presentation, Sprint 4G provides industry solution areas, industry benefits, and technology mapping, and Sprint 4H provides frequently asked questions, FAQ structured data, delivery trust indicators, and the quick-contact panel. Each composition is exposed through the feature's public barrel; client state is isolated to established interaction primitives such as the workflow explorer and accessible disclosure system.
