...
- `src/features/services`: the services landing-page vertical slice. Sprint 5A owns the `/services` presentation, service-offering data, service-specific FAQ content, process, technology mapping, and page schema sources. It does not own service-detail routes.
